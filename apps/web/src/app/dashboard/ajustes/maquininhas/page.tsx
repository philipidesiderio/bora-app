  ...
  return (
    <div className="max-w-lg mx-auto pb-28 md:pb-6">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="font-heading text-xl font-bold">Maquininhas</h1>
      ...
      <div className="flex flex-col items-center justify-center py-16 text-center space-y-4">
        ...
        <h2 className="font-heading text-lg font-bold">Maquininhas</h2>
        <p className="text-muted-foreground text-sm max-w-xs">
          Integre sua maquininha (Stone, Cielo, Rede, PagSeguro) diretamente ao PDV para pagamentos automáticos.
        </p>
