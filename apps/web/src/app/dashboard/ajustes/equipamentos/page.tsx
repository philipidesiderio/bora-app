  ...
  return (
    <div className="max-w-lg mx-auto pb-28 md:pb-6">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="font-heading text-xl font-bold">Equipamentos</h1>
          <p className="text-xs text-muted-foreground">Impressoras e periféricos</p>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center justify-center py-16 text-center space-y-4">
        ...
        <h2 className="font-heading text-lg font-bold">Equipamentos</h2>
        <p className="text-muted-foreground text-sm max-w-xs">
          Configure impressoras térmicas, leitores de código de barras e outros periféricos do PDV.
        </p>
